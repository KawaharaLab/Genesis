...
def set_path(object_name, coup_friction, material_type):
    ...
    default_video_path = f"{video_object_path}/{object_name}_{material_type}_{coup_friction}.mp4"
    default_outfile_path = f"{outfile_object_path}/{object_name}_{material_type}_{coup_friction}.csv"
    base_photo_name = f"{photo_friction_path}/{object_name}_{material_type}_{coup_friction}"
